...
\begin{figure}[ht]
	...
	\caption{A figure showing the maximum relative error given by the equation \ref{eq:rel_error} versus the number of linearly spaced grid points $n$. Note the linear behaviour in the of the graph before $\log_{10} \approx 5$. 
	\label{fig:specerror}
\end{figure}
